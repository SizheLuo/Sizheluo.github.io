...
### <a name="chapter8"></a>第八章 leetcode高频题目
...
![](https://s3.uuu.ovh/imgs/2023/05/18/101d8028170c9d50.png)
...
![](https://s3.uuu.ovh/imgs/2023/05/24/91cb378048212554.png)
...
### <a name="chapter8"></a>第九章 数组

#### 1365.有多少小于当前数字的数字 ####

![](https://s3.uuu.ovh/imgs/2023/05/26/2cb3b26602bfe652.png)
	...
	public:
	    vector<int> smallerNumbersThanCurrent(vector<int>& nums) {
	        ...
	        for (int i = 0; i < nums.size(); i++) {
	            res.emplace_back(hashTable[nums[i]]);
	        }
...
![](https://s3.uuu.ovh/imgs/2023/05/26/4c70c0f464566b5c.png)
